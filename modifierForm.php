...
<div class="row justify-content-center">
   <form action="modifier.php" method="GET">
    <fieldset>
        <legend >Modifier Materiel</legend>
    ...
    <div class="form-group">
    <button type="submit" name="modifier" class="btn btn-primary" value="modifier"  onClick="return confirmation()">Modifier</button>
    <button type="reset" name="annuler" class="btn btn-danger"value="annuler">Annuler</button>

    <script type="text/javascript">
		 function confirmation(){ 
			var sup=confirm('Vous voulez modifier ce Matériel ?');		
		    return sup;   
			}
				</script> 
    </div>
